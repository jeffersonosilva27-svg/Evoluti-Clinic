...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[30%] h-[30%] bg-indigo-100/50 rounded-full blur-3xl" />

      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-blue-100 border border-slate-100 p-8 md:p-12 relative z-10"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mb-6">
            ...
            <>
              <div>
                ...
                <input 
                  ...
                  className="w-full h-12 px-4 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none text-sm font-medium"
          ...
          <div>
            ...
            <input 
              ...
              className="w-full h-12 px-4 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none text-sm font-medium disabled:opacity-50"
          ...
          <button
            ...
            className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 shadow-md shadow-blue-600/20 active:scale-95 disabled:opacity-50 mt-2"
          >
        ...
        {(!user || profile) ? (
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full h-14 bg-white border-2 border-slate-100 hover:border-blue-600 text-slate-700 font-bold rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 shadow-sm hover:shadow-md active:scale-95 disabled:opacity-50"
            >
